    ...
    <div className="min-h-screen bg-[#111827] flex font-sans">
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        <div className="relative">
            {/* This div hides the dropdown box on PDF */}
            ...
            {/* This span ONLY shows up on the PDF */}
            <span className="hidden print:block text-slate-800 font-medium text-sm py-2.5">Date Range: All Time</span>
          </div>
         ...
         <div className="relative">
            ...
            {/* This span ONLY shows up on the PDF */}
            <span className="hidden print:block text-slate-800 font-medium text-sm py-2.5">Status: All</span>
          </div>
      </div>
        {loading ? (
