    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#111827] flex font-sans transition-colors duration-200">
      ...
      <main className="flex-1 p-8 overflow-auto">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input 
                ...
                className="bg-white dark:bg-[#242F41] text-sm text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700/30 rounded-lg pl-9 pr-4 py-2 w-72 focus:outline-none focus:border-blue-500 dark:focus:border-slate-500 placeholder:text-slate-400 dark:placeholder:text-slate-500 transition-colors duration-200"
              />
            </div>
            <ExportButton data={devices} filename="alerto_devices_export.csv" label="Export Data" />
            <button className="flex items-center gap-2 bg-blue-600 dark:bg-slate-600 hover:bg-blue-700 dark:hover:bg-slate-500 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
              + Add New Device
            </button>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-[#242F41] rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700/30 flex justify-between items-start transition-colors duration-200">
            <div>
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium mb-1">Total Devices</p>
          ...
          <div className="bg-white dark:bg-[#242F41] rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700/30 flex justify-between items-start transition-colors duration-200">
            <div>
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium mb-1">Active Nodes</p>
              <div className="flex items-baseline gap-2">
          ...
          <div className="bg-white dark:bg-[#242F41] rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700/30 flex justify-between items-start transition-colors duration-200">
            <div>
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium mb-1">Low Battery Alert</p>
              <div className="flex items-baseline gap-2">
                <h3 className="text-3xl font-bold text-slate-900 dark:text-white">12</h3>
                <span className="text-rose-600 dark:text-rose-400 text-sm font-medium">-10%</span>
              </div>
            </div>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20 text-slate-500 dark:text-slate-400">Loading devices...</div>
        ) : (
