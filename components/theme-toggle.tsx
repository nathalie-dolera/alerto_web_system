...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#151a23] hover:bg-slate-700/40 text-slate-300 hover:text-white border border-slate-700/50 transition-all cursor-pointer shadow-sm shrink-0"
